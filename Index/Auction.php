<?php
    ...
    if(isset($_SESSION['a']))
    {
		...
		$sql="SELECT product.Product_ID,product.Name,product.Price,Image,farmerdetails.City FROM product JOIN farmerdetails ON product.Farmer_ID=farmerdetails.FarmerID WHERE AFlag='1'";
...
<div class="image">
        <a href="AuctionProductView.php?proid=<?php echo $rows['Product_ID'];?>"><img src="<?php echo $rows['Image'];?>" style="height:250px;width:250px;"/></a>
                    <div class="home-product-bottom">
                            ...
                            <p style="text-transform: uppercase;font-weight: bold;text-align:left;"> Starting Bid:<?php echo $rows3['Bid'];?></p>
