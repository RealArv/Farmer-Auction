<?php
    ...
    $sql="SELECT invoice.*, product.Name, product.Type from invoice
    join product on product.Product_ID = invoice.Product_ID
    where invoice.Consumer_ID = $sessionProfile";
                ...
                <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                        <thead>
                            <tr>
                                ...
                                <th class="table-class">Quantity purchased</th>
                                <th class="table-class">Total</th>
                            </tr>
                        </thead>
                        <tbody>
