...
<!-------------------------------------database----------------------------->
    ...
    <?php require_once 'process2.php';?>
        ...
        <?php
          ...
          $result = $mysqli->query("select * from farmerdetails") or die($mysqli->error);
        ?> 
...
<!--------------------------------admin details---------------------------------->
  ...
  <?php
        ...
        <tr>
          ...
          <td><?php echo $row['KisanID'] ?></td>
          <td><?php echo $row['Fname'] ?></td>
          <td><?php echo $row['Phone'] ?></td>
          <td><?php echo $row['Status'] ?></td>
          <td>
                 <a href="farm.php?verify=<?php echo $row['FarmerID']; ?>"
                  class="btn btn-primary">Verify</a>&nbsp;
                 <a href="farm.php?unverify=<?php echo $row['FarmerID']; ?>"
                  class="btn btn-warning">Unverify</a>&nbsp;
                 <a href="farm.php?delete=<?php echo $row['FarmerID']; ?>"
